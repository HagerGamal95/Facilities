...
class ServiceDetailsViewController: UIViewController {
    ...
    @IBOutlet weak var feesSubtitleLabel: UILabel!
    ...
    func setupUI() {
        ...
        if let data = service?.fees?.data(using: String.Encoding.unicode){
            try? feesSubtitleLabel.attributedText = NSAttributedString(data: data, options: [.documentType: NSAttributedString.DocumentType.html], documentAttributes: nil)
        }
